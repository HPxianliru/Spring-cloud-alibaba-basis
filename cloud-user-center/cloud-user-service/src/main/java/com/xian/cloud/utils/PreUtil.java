...
import com.xian.cloud.vo.MenuMetaVo;
import com.xian.cloud.vo.MenuVo;
...
public class PreUtil {
    ...
    public List<MenuVo> buildMenus(List<MenuEntity> sysMenuList) {
        List<MenuVo> list = new LinkedList<>();

        sysMenuList.forEach(sysMenu -> {
                    if (sysMenu != null) {
                        List<MenuEntity> menuDTOList = sysMenu.getChildren();
     ...
     * @param menuType
     */
    public void findChildren(List<MenuEntity> menuList, List<MenuEntity> menus, int menuType) {
     ...
     * @param depts
     */
    public void findChildren(List<DeptEntity> sysDepts, List<DeptEntity> depts) {
     ...
     * @param depts
     */
    public void findChildren1(List<DeptTreeVo> sysDepts, List<DeptEntity> depts) {
     ...
     * @return
     */
    public boolean exists(List<MenuEntity> sysMenus, MenuEntity sysMenu) {
        boolean exist = false;
