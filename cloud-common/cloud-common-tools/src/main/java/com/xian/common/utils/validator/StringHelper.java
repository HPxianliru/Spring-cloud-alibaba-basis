...
import com.xian.common.utils.encode.EncodeUtils;
...
public class StringHelper extends StringUtils {
    ...
    public static void main(String[] args) {
        System.out.println(StringHelper.matchDomain("515608851@qq.com"));
        System.out.println(StringHelper.matchDomain("www.qq.com"));
        System.out.println(StringHelper.matchDomain("qq.com"));
        System.out.println(StringHelper.matchIp("qq.com"));
        System.out.println(StringHelper.matchIp("192.168.0.1"));
